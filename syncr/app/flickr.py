...
class FlickrSyncr:
    ...
    def getPhotoSizes(self, photo_id):
        ...
        for label in ('Large Square','Square','Thumbnail','Small','Small 320','Medium','Medium 640','Medium 800','Large','Large 1600','Large 2048','Original'):
    ...
    def _syncPhoto(self, photo_xml, refresh=False):
        ...
        taken_date = strptime(photo_xml.photo[0].dates[0]['taken'].replace('-00','-01'), "%Y-%m-%d %H:%M:%S")
